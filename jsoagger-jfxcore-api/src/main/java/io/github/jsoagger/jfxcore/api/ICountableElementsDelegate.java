 ...
 * @date 2019
 */
public interface ICountableElementsDelegate {

  /**
   * Call {@link #setElementStatus(List, int)} by building list argument.
   *
   * @param element
   * @param status
   */
  public default void setElementStatus(Object element, int status, OperationCallback callback) {
    setElementStatus(Arrays.asList(element), status, callback);
  }
