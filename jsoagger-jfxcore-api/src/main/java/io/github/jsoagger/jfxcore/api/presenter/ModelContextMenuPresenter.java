...
public interface ModelContextMenuPresenter extends ModelPresenter, ICellPresenter {
  ...
  Node provideContextMenu(IJSoaggerController controller, VLViewComponentXML configuration);


  Node provideContextMenu(IJSoaggerController controller, VLViewComponentXML configuration, Object forModel);
}
