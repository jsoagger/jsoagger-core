...
public interface ICriteriaEvaluator {
  ...
  /**
   * Evaluates the given filter from {@link CriteriaContext}. Criterias computation must be done
   * before calling.
   */
  public boolean evaluate(IJSoaggerController controller, VLViewFilterXML filter, ICriteriaContext criteriaContext);
}
