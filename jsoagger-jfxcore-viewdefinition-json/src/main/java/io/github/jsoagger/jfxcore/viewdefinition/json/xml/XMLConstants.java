...
package io.github.jsoagger.jfxcore.viewdefinition.json.xml;
...
public abstract class XMLConstants {
	...
	public final static String	COUNTER				= "charCounter";
	public final static String	FOCUSED				= "focused";
	public final static String	COUNTABLE			= "countable";
	...
	public final static String	LOAD_ROOT_VIEW		= "loadRootView";
	public final static String	LOAD_WIZARD_VIEW	= "loadWizardView";
	public final static String	LOAD_CHILD_VIEW		= "loadChildView";
	...
	public final static String	PICKER_TITLE		= "pickerTitle";

	public final static String	DATE					= "date";
	public final static String	COLNUMBER				= "colNumber";
	...
	public final static String	SORT					= "icon";
	public final static String	CLASS					= "class";
	public final static String	HEIGHT					= "height";
	public final static String	WIDTH					= "width";
	public final static String	DIALOG					= "dialog";
	public final static String	SHOW_STEPS				= "showSteps";
	public final static String	DIALOG_WIDTH			= "dialogWidth";
	public final static String	DIALOG_HEIGHT			= "dialogHeight";
